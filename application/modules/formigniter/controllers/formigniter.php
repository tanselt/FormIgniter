...
class Formigniter extends MY_Controller
{
...
//		}
		...
		$view .= "					
	<?php echo form_textarea( array( 'name' => '$field_name', 'rows' => '4', 'class' => 'form-control', 'value' => set_value('$field_name') ) )?>";
						break;
		...
		$view .= '<div class="radio">
                ...
                <label><input id="'.$field_name.'1" name="'.$field_name.'" type="radio" class="" value="option1" <?php echo $this->form_validation->set_radio(\''.$field_name.'\', \'option1\'); ?> />
        		Radio option 1</label>

        		<label><input id="'.$field_name.'2" name="'.$field_name.'" type="radio" class="" value="option2" <?php echo $this->form_validation->set_radio(\''.$field_name.'\', \'option2\'); ?> />
...
EOT;
       ...
       <?php echo form_dropdown("'.$field_name.'", $options, set_value("'.$field_name.'")," class=\'form-control\'")?>                                           
                        ';
                        break;
...
<div class="checkbox">
     ...
     <label><input type="checkbox" id="{$field_name}1" name="{$field_name}" value="enter_value_here" class="" <?php echo set_checkbox('{$field_name}', 'enter_value_here'); ?>>{$field_label}</label>
	<label><input type="checkbox" id="{$field_name}2" name="{$field_name}" value="enter_value_here" class="" <?php echo set_checkbox('{$field_name}', 'enter_value_here'); ?>>{$field_label}</label>
</div> 
EOT;
                        break;
                        ...
                        $view .= <<<EOT
		<input id="{$field_name}" class="form-control" type="{$type}" name="{$field_name}" {$maxlength} value="<?php echo set_value('{$field_name}'); ?>"  /><?php echo form_error('{$field_name}');?>
